 ...
 * @version 1
 */
public class PaddlePlayerTwo extends Actor
{
    private int width;
    private int height;
    private int dx;
    ...
    GreenfootImage PaddlePlayerTwo= new GreenfootImage("red neon.png");
    /**
     * Constructs a new paddle with the given dimensions.
     */
    public PaddlePlayerTwo(int width, int height)
    {
        this.width = width;
        this.height = height;
        dx = 2;
        setImage(PaddlePlayerTwo);
    }
    ...
    private void keyboardControl()
    {
        ...
        {
            /*When pressing the "a" key, we calculate the potential new x-coordinate 
        ...
        {
            /*When pressing the "d" key, we calculate the potential new x-coordinate  
            for moving right (newRight) by adding 2 * dx to the current x-coordinate*/
